...
#     plt.show()
    ...
    for red_mask in red_masks:
        ...
        if all_sorted_cnt_red is not None:
            ...
            if similarity_level_ori_red < 0.2:
                if cv2.contourArea(largest_ori_red_cnt) < (w * h) / 18:
                ...
                approx_red_1 = cv2.approxPolyDP(largest_ori_red_cnt, 0.04 * cv2.arcLength(largest_ori_red_cnt, True), True)
    ...
    for mask_red in mask_red_list:
        ...
        print('type rgb_img_red:',type(rgb_img_red))
        rgb_img_red = text_box_on_img(mask_red, rgb_img_red, text='speed limit')
        print('type rgb_img_red after:',type(rgb_img_red))

    rgb_img_yellow_orange = rgb_img_red
...
#         print('type rgb_img_yellow_orange after:',type(rgb_img_yellow_orange))
        rgb_img_yellow_orange = text_box_on_img(convex_fixed_red_img, rgb_img_yellow_orange, text='speed limit')

    rgb_img_white = rgb_img_yellow_orange
    for output_white in output_white_list:
...
#         print('type rgb_img_white after:',type(rgb_img_white))
        rgb_img_white = text_box_on_img(convex_fixed_red_img, rgb_img_white, text='speed limit')

    # Store all labeled frames:
    output_labeled_img_list.append(rgb_img_white)
