...
def process_frame(frame):
	...
	# Yellow:
	lower_yellow_orange, upper_yellow_orange = (7, 70, 0), (65, 255, 200)
	...
	lower_yellow_orange2, upper_yellow_orange2 = (7, 150, 30), (65, 255, 200)
	...
	# Green:
	lower_green, upper_green = (70, 70, 0), (130, 255, 255)
	...
	lower_green2, upper_green2 = (70, 100, 50), (130, 255, 255)
	...
	if green_contours is not None:
		for cnt in green_contours:
			...
			similarity_level_fix_green = shape_compare(fixed_shape, dimond_shape_template_cnt)
	...
	for cnt in cnts:
		x, y, w, h = cv2.boundingRect(cnt)
		if w * h < r * c * 0.0007 or w * h > r * c * 0.1 or w > h or w < h * 0.55:
			continue
