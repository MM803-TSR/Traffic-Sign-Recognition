...
#         plt.show()
        ...
        if output_red is not None:
            ...
            mask_red_list.append(final_red_mask)
#          Image.fromarray(output_red).save('sample_images/cropped_video_4/output_output_red_%d_%d.jpg'%(frame_i,a)
            img_draw_box_red = text_box_on_img(final_red_mask,rgb_img,text="speed limit")
...
#         plt.show()
        ...
        if output_yellow_orange is not None:
            ...
            mask_yellow_orange_list.append(final_yellow_orange_mask)
    ...
    if all_sorted_green_orange is not None:
        ...
        if output_green is not None:
            ...
            mask_green_list.append(final_green_mask)
...
#         plt.show()
        ...
        if similarity_level_fix_white < similarity_level_fix_white2:
            ...
            if output_white is not None:
                ...
                mask_white_list.append(final_white_mask1)
#                 Image.fromarray(output_white).save('sample_images/cropped_video_4/output_output_white_%d_%d.jpg'%(frame_i,c))
            ...
            if output_white is not None:
                ...
                plt.show()
                output_white_list.append(output_white)
                mask_white_list.append(final_white_mask2)
#                 Image.fromarray(output_white).save('sample_images/cropped_video_4/output_output_white_%d_%d.jpg'%(frame_i,c))
...
for output_labeled_img in output_labeled_img_list:
    Image.fromarray(output_labeled_img).save('sample_images/labeled_video_8/output_labeled_frames_%d.jpg'%b)
    b += 1
